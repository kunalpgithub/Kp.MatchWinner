...
namespace Kp.MatchWinner.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MatchWinnerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MatchWinnerEfCoreEntityExtensionMappings to extend the IdentityUser entity
